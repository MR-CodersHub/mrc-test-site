...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (window.__MRC_UI_INITIALIZED__) return;
    window.__MRC_UI_INITIALIZED__ = true;

    // 2. Clear any stuck body overflow (failsafe for refresh behavior)
    document.body.style.overflow = '';

    // 3. Inject Tailwind Configuration safely
    ...
    // 3. Initial UI Injection
    injectGlobalUI();
    
    // 4. Ensure Lucide is initialized
...
function handleActiveLinks() {
    ...
    navLinks.forEach(link => {
        ...
        if (isMatch) {
            ...
            // Highlight Desktop Dropdown Parent Trigger
            const dropdownParent = link.closest('.group');
            if (dropdownParent) {
                const trigger = dropdownParent.querySelector('.nav-dropdown-trigger');
                if (trigger) trigger.classList.add('nav-link-active');
            }

            // Highlight sub-item dots if present
            const subDot = link.querySelector('div.rounded-full');
            if (subDot) {
                subDot.classList.remove('bg-brand-blue/20', 'bg-pink-200');
                subDot.classList.add('bg-brand-blue');
            }
        }
    });
}
...
function initNavbar() {
    ...
    if (mobileMenuBtn && !mobileMenuBtn.dataset.listenerAttached) {
...
// Global UI Injection
// ──────────────────────────────────────────
const GLOBAL_FAVICON = './assets/img/icon.png';
const GLOBAL_NAV = `\n<nav id="global-nav"
        ...
        <div class="max-w-7xl mx-auto w-full flex justify-between items-center">
            ...
            <div
                class="hidden lg:flex items-center lg:space-x-4 xl:space-x-8 lg:text-[12px] xl:text-sm font-medium text-gray-600 mx-4">
                <a href="./index.html" class="hover:text-brand-blue transition whitespace-nowrap">Home</a>
                <a href="./about.html" class="hover:text-brand-blue transition whitespace-nowrap">About Us</a>

                <div class="relative group h-full flex items-center">
                    <div
                        class="nav-dropdown-trigger hover:text-brand-blue transition flex items-center gap-1 outline-none py-2 group-hover:text-brand-blue whitespace-nowrap cursor-default">
                        For Students
                    ...
                    <!-- Dropdown Content -->
                    <div
                        class="absolute top-full left-1/2 -translate-x-1/2 pt-6 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 w-72 z-50">
                        <div
                            class="bg-white/95 backdrop-blur-xl border border-gray-200 rounded-2xl p-2 shadow-2xl shadow-blue-500/10 ring-1 ring-black/5">
                            ...
                            <div class="px-4 py-3 mt-1">
                                ...
                                <div class="grid grid-cols-1 gap-1">
                                    ...
                                    <a href="./college-projects.html" class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-brand-blue/5 text-gray-600 hover:text-brand-blue transition-all group/sub">
                                        <div class="w-1.5 h-1.5 rounded-full bg-brand-blue/20 group-hover/sub:bg-brand-blue transition-colors"></div>
                                        <span class="text-[12px] font-bold">College Projects</span>
                                    </a>
                                    </div>
                            </div>
                        </div>
                ...
                <div class="relative group h-full flex items-center">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <!-- Services Section -->
                            <div class="px-4 py-3 mt-1 border-t border-gray-50">
                                <p class="text-[10px] font-black text-brand-blue uppercase tracking-[0.2em] mb-3 ml-1">Services</p>
                                <div class="grid grid-cols-1 gap-1">
                                    <a href="./category2.html" class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-brand-blue/5 text-gray-600 hover:text-brand-blue transition-all group/sub">
                                        <div class="w-1.5 h-1.5 rounded-full bg-brand-blue/20 group-hover/sub:bg-brand-blue transition-colors"></div>
                                        <span class="text-[12px] font-bold">Digital Marketing</span>
                                    </a>
                                    <a href="./category3.html" class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-brand-blue/5 text-gray-600 hover:text-brand-blue transition-all group/sub">
                                        <div class="w-1.5 h-1.5 rounded-full bg-brand-blue/20 group-hover/sub:bg-brand-blue transition-colors"></div>
                                        <span class="text-[12px] font-bold">Web Development</span>
                                    </a>
                                     <a href="./category4.html" class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-brand-blue/5 text-gray-600 hover:text-brand-blue transition-all group/sub">
                                        <div class="w-1.5 h-1.5 rounded-full bg-brand-blue/20 group-hover/sub:bg-brand-blue transition-colors"></div>
                                        <span class="text-[12px] font-bold">Hardware Projects</span>
                                    </a>
                                </div>
                            </div>
                ...
                <a href="./projects.html" class="hover:text-brand-blue transition whitespace-nowrap">Projects</a>
                <a href="./blog.html" class="hover:text-brand-blue transition whitespace-nowrap">Blogs</a>
                <a href="./contact.html" class="hover:text-brand-blue transition whitespace-nowrap">Contact</a>
            </div>
                ...
                <div class="space-y-10">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-1 pl-4 border-l-2 border-gray-100">
                            ...
                            <a href="./college-projects.html" class="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 group transition-all">
                                <span class="font-bold text-gray-700">College Projects</span>
                                <svg class="w-4 h-4 text-gray-300 group-hover:text-brand-blue transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                            </a>
                         </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-[10px] font-black text-brand-blue uppercase tracking-[0.3em]">Business Solutions</p>
                        </div>
                        <div class="grid grid-cols-1 gap-1 pl-4 border-l-2 border-gray-100">
                            ...
                            <a href="./category4.html" class="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 group transition-all">
                                <span class="font-bold text-gray-700">Hardware Projects</span>
                                <svg class="w-4 h-4 text-gray-300 group-hover:text-brand-blue transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                            </a>
                        </div>
                    </div>
...
const GLOBAL_FOOTER = `<footer id="global-footer" class="bg-gradient-to-b from-slate-950 to-slate-900 text-white pt-16 pb-12 px-6 md:px-8 lg:px-10 relative overflow-hidden">
    ...
    if (!document.getElementById('global-nav-styles')) {
        ...
        style.textContent = `
            ...
            @media (max-width: 1023px) {
                ...
                /* Hard fallback to ensure desktop items are hidden on mobile viewports */
                #global-nav .hidden.lg\\:flex,
                #global-nav .lg\\:flex.items-center {
                    display: none !important;
                }
            }
            
            /* Ensure desktop nav NEVER shows mobile button */
            ...
            /* Standardized Z-Index Architecture */
            #global-nav { z-index: 100 !important; }
            #global-mobile-menu { z-index: 1000 !important; }
            #global-mobile-menu-overlay { z-index: 1000 !important; }
            #global-mobile-menu-container { z-index: 1001 !important; }
            ...
            /* Indicator dash for top-level desktop nav items */
            nav .nav-link-active:not(.rounded-xl):not(.rounded-full) {
                position: relative;
            }
            ...
            nav .nav-link-active:not(.rounded-xl):not(.rounded-full)::after {
                content: '';
                position: absolute;
                bottom: -4px;
                left: 50%;
                ...
                animation: activeDash 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
            }

            .nav-link-active.rounded-xl {
